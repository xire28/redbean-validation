...
class Validations
{
    ...
    protected static $VALIDATION_FUNCTIONS = array(
    ...
    protected static $DEFAULT_VALIDATION_OPTIONS = array(
        'on' => 'save',
        'allow_null' => false,
        'allow_blank' => false,
        'message' => null,
    ...
    protected static  $ALL_RANGE_OPTIONS = array(
        'is' => null,
        'within' => null,
        'in' => null,
        'minimum' => null,
    ...
    public function __construct($model)
    {
        ...
        $this->klass = new \ReflectionClass(get_class($this->model));
    ...
    public function validates_uniqueness_of($attrs)
    {
        ...
        foreach ($attrs as $attr)
        {
            ...
            $pk_value = isset($this->model->$pk)? $this->model->$pk : null;
            ...
            $duplicates = \R::find($table_name, $sql, $conditions);
            if (!empty($duplicates))
...
class Errors implements IteratorAggregate
{
    ...
    static $DEFAULT_ERROR_MESSAGES = array(
     ...
     *
     * @param mixed $model The model the error is for
     * @return Errors
     */
    public function __construct($model)
    {
